...
class eppCreateContactRequest extends eppContactRequest {
    ...
    public function setAppId($appId)
    {
        if ($appId) {
            ...
            $appIdCreate = $this->createElement('AppID', $appId);
            $this->extension->appendChild($appIdCreate);
            $this->addSessionId();
        }
    }
    ...
    public function setCmpId($cmpId)
    {
        if ($cmpId) {
            ...
            $cmpIdCreate = $this->createElement('CmpID', $cmpId);
            $this->extension->appendChild($cmpIdCreate);
            $this->addSessionId();
        }
    }
}
